...
import requests
from service.rapyd.models.checkout import CheckoutModel, CreateCheckoutModel
from service.rapyd.models.payment import CreatePaymentModel, PaymentModel
from service.rapyd.models.paymentMethod import CustomerPaymentMethod

from service.rapyd.models.customers import CreateCustomer, Customer
...
class RapydService:
    ...
    def get_list_payment_methods_by_country(self, country, currency):
        api_response = requests.get(**self.__prepare_request('get', f'/v1/payment_methods/country?country={country}&currency={currency}'))
    ...
    @staticmethod 
    def get_error_message(res: requests.Response):
        error = None
        try:
            error = res.json()
        except:
