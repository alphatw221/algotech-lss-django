...
def api_youtube_get_live_chat_comment_with_api_key(page_token: str, live_chat_id: str, max_results: int):
    params = {
...
def api_youtube_get_live_chat_comment_with_access_token(access_token: str, page_token: str, live_chat_id: str, max_results: int):
    params = {
        # "key": settings.YOUTUBE_API_KEY,
        "maxResults": max_results,
        "part": "id,snippet,authorDetails",
