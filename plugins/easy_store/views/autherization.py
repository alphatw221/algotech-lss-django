...
class AuthViewSet(viewsets.GenericViewSet):
    ...
    @action(detail=False, methods=['GET'], url_path=r'credential/exchange', permission_classes=(), authentication_classes=[])
    ...
    def exchange_easy_store_credential(self, request):
        ...
        lib.util.verify.Verify.get_seller_user()
