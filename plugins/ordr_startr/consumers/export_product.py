...
class ExportProductConsumer(WebsocketConsumer):
    ...
    def connect(self):
        ...
        self.room_group_name = f'user_subscription_{user_subscription.id}_{PLUGIN_ORDR_STARTR}_product_export'
    ...
    def receive(self, text_data):
        ...
        service.rq.queue.enqueue_general_queue(jobs.ordr_startr.export_product_job, user_subscription_id = user_subscription.id, credential=credential)
