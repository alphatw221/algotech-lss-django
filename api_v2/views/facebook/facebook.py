...
class FacebookViewSet(viewsets.GenericViewSet):
    queryset = models.facebook.facebook_page.FacebookPage.objects.none()
    
    @action(detail=True, methods=['GET','POST'], url_path=r'webhook/messenger')
