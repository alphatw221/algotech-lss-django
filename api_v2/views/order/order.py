...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    def guest_upload_receipt(self, request, order_oid):
        ...
        subject = lib.i18n.email.order_comfirm_mail.i18n_get_mail_subject(order=order, lang=order.campaign.lang)
        content = lib.i18n.email.order_comfirm_mail.i18n_get_mail_content(order=order, lang=order.campaign.lang)
