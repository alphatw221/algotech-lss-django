...
class OrderProductViewSet(viewsets.ModelViewSet):
    ...
    @lib.error_handle.error_handler.api_error_handler.api_error_handler
    def seller_search_order_product(self, request):
        pass

    @action(detail=False, methods=['GET'], url_path=r'seller/report/json', permission_classes=(IsAuthenticated,))
    @lib.error_handle.error_handler.api_error_handler.api_error_handler
    def seller_get_order_product_json_report(self, request):
        pass
