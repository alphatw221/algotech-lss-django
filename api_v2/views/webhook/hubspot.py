...
class HubspotViewSet(viewsets.GenericViewSet):
    ...
    def handle_new_registeration_from_hubspot(self, request):
        ...
        lib.util.verify.Verify.is_hubspot_signature_valid(request)
        ...
        user_subscription = models.user.user_subscription.UserSubscription.objects.create(
            ...
            user_plan= {"activated_platform" : [models.user.user_subscription.PLATFORM_FACEBOOK, models.user.user_subscription.PLATFORM_INSTAGRAM, models.user.user_subscription.PLATFORM_YOUTUBE]}, 
        ...
        api_user = models.user.user.User.objects.create(
            name=f'{first_name} {last_name}', 
            email=email, 
            type=models.user.user.TYPE_SELLER, 
            status=models.user.user.STATUS_VALID, 
        ...
        deal_obj = models.user.deal.Deal.objects.create(
            user_subscription=user_subscription,
            original_plan=None,
            purchased_plan=business_policy.subscription.TYPE_TRIAL,
            total=0, 
            payer=api_user, 
