...
SHOPPING_CART_LOGIN_URL = f"{GCP_API_LOADBALANCER_URL}/buyer/login/cart"
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'noreply@liveshowseller.net'  # derekhwang@accoladeglobal.net noreply@liveshowseller.com
EMAIL_HOST_PASSWORD = 'bbbmncinwtthxfuw'  # jyhudyfbvpmewjsc   bq5^82DrrpQ4'
...
#rebrandly api key
REBRANDLY_API_KEY = '6071f384cef545938e05a2a9335278a8'