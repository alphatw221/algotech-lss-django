...
class OrderReport(XlsxHelper):
    ...
    columns=[
            FieldMapper('id','ID', i18n_key=_('REPORT/COLUMN_TITLE/ID')),
            DateTimeMapper('created_at', 'Order Date', i18n_key=_('REPORT/COLUMN_TITLE/ORDER_DATE')),
            FieldMapper('platform', 'Platform', i18n_key=_('REPORT/COLUMN_TITLE/PLATFORM')),
            CustomerNameMapper('customer_name', 'Customer Name', i18n_key=_('REPORT/COLUMN_TITLE/CUSTOMER_NAME')),
            ShippingNameMapper('shipping_name', 'Shipping Name', i18n_key=_('REPORT/COLUMN_TITLE/SHIPPING_NAME')),
            FieldMapper('shipping_phone', 'Shipping Phone', i18n_key=_('REPORT/COLUMN_TITLE/SHIPPING_PHONE')),
            FieldMapper('shipping_email', 'E-mail', i18n_key=_('REPORT/COLUMN_TITLE/EMAIL')),
            ShippingMethodMapper('shipping_method', 'Shipping Method', i18n_key=_('REPORT/COLUMN_TITLE/SHIPPING_METHOD')),
            ShippingOptionMapper('shipping_option', 'Shipping Option', i18n_key=_('REPORT/COLUMN_TITLE/SHIPPING_OPTION')),
            DeliveryInfonMapper('shipping_address_1', 'Shipping Address 1', i18n_key=_('REPORT/COLUMN_TITLE/SHIPPING_ADDRESS_1')),
            DeliveryInfonMapper('shipping_location', 'Location', i18n_key=_('REPORT/COLUMN_TITLE/LOCATION')),
            DeliveryInfonMapper('shipping_region', 'Region', i18n_key=_('REPORT/COLUMN_TITLE/REGION')),
            DeliveryInfonMapper('shipping_postcode', 'Postcode', i18n_key=_('REPORT/COLUMN_TITLE/POSTCODE')),
            PickupStoreMapper('pick_up_store', 'Pick up Store', i18n_key=_('REPORT/COLUMN_TITLE/PICK_UP_STORE')),
            PickupAddressMapper('pickup_address', 'Pick up Address', i18n_key=_('REPORT/COLUMN_TITLE/PICK_UP_ADDRESS')),
            FieldMapper('shipping_remark', 'Remark', i18n_key=_('REPORT/COLUMN_TITLE/REMARK')),
            PaymentMethodMapper('payment_method', 'Payment Method', i18n_key=_('REPORT/COLUMN_TITLE/PAYMENT_METHOD')),
            FieldMapper('status', 'Payment Status', i18n_key=_('REPORT/COLUMN_TITLE/PAYMENT_STATUS')),
            LastFiveDigitMapper('last_five_digit', 'Payment Record', i18n_key=_('REPORT/COLUMN_TITLE/PAYMENT_RECORD')),
            TotalMapper('total', 'Total', i18n_key=_('REPORT/COLUMN_TITLE/TOTAL')),
        ]
