...
def i18n_get_mail_content(order, user, lang=None):
    ...
    mail_content += f"""
      <div style="margin-top: 1%; font-size: 0.9rem; line-height: 2;">
        <p style="text-align: left; font-weight: 700; font-size: 1rem; line-height: 2;">""" + _('EMAIL/DELIVERY_CONFIRM/SHIPPING_INFO') + f"""
        </p>
        <div style="border-bottom: 3px solid #ffd000; width: 20%; margin-bottom: 3%;"></div>
          <table cellspacing="0" cellpadding="0" border="0" width="100%" style="min-width: 100%;" role="presentation">
            <tbody>
              <tr>
                <td style="color: #4b4b4b; font-weight: 600; width: 35%; text-align:left;" valign="top">""" + _('EMAIL/DELIVERY_CONFIRM/SHIPPING_DATE') + f"""
                : {shipping_date}
                </td>
              </tr>
              <tr>
                <td style="color: #4b4b4b; font-weight: 600; width: 35%; text-align:left;" valign="top">""" + _('EMAIL/DELIVERY_CONFIRM/DELIVERY_ADDRESS') + f"""
                : {order.shipping_location},{order.shipping_region},{order.shipping_postcode},{order.shipping_address_1}
                </td>
              </tr>
              <tr>
                <td style="color: #4b4b4b; font-weight: 600; width: 35%; text-align:left;" valign="top">""" + _('EMAIL/DELIVERY_CONFIRM/REMARK') + f"""
