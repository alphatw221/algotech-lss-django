# Generated by Django 3.2.8 on 2021-11-15 11:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history', djongo.models.fields.JSONField(blank=True, default=None, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Sample',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('cost', models.CharField(blank=True, default='0.00', max_length=255, null=True)),
                ('cost_currency', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('points', models.IntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_code', models.CharField(blank=True, max_length=255, null=True)),
                ('platform', models.CharField(blank=True, max_length=255, null=True)),
                ('platform_id', models.CharField(blank=True, max_length=255, null=True)),
                ('platform_email', models.CharField(blank=True, max_length=255, null=True)),
                ('remark', models.TextField(blank=True, default=None, null=True)),
                ('type', models.CharField(blank=True, max_length=255, null=True)),
                ('status', models.CharField(blank=True, max_length=255, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
