...
class OrderProduct(models.Model):
    ...
    campaign = models.ForeignKey(Campaign, on_delete=models.CASCADE, related_name='order_products')

    campaign_order = models.ForeignKey(CampaignOrder, on_delete=models.CASCADE, related_name='order_products')

    campaign_product = models.ForeignKey(CampaignProduct, on_delete=models.CASCADE, related_name='order_products')

    campaign_comment = models.ForeignKey(CampaignComment, on_delete=models.CASCADE, related_name='order_products')
