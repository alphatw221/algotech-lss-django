...
class FacebookCampaignSerializer(serializers.Serializer):
    ...
    comment_capture_since = serializers.FloatField(required=False, default=1, allow_blank=True)
...
class YoutubeCampaignSerializer(serializers.Serializer):
    ...
    is_failed = serializers.BooleanField(required=False, default=False, allow_blank=True)
    latest_comment_time = serializers.FloatField(required=False, default=1, allow_blank=True)
    remark = serializers.CharField(required=False, default="", allow_blank=True)
    ...
    last_refresh_timestamp = serializers.FloatField(required=False, default=1, allow_blank=True)
