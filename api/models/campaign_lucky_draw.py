...
class CampaignLuckyDraw(models.Model):
    ...
    campaign = models.ForeignKey(Campaign, on_delete=models.CASCADE, related_name='campaign_lucky_draws')

    campaign_product = models.ForeignKey(CampaignProduct, on_delete=models.CASCADE, related_name='campaign_lucky_draws')
