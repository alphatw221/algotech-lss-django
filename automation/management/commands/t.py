...
class Command(BaseCommand):
    ...
    def convert_arimme(self):
        ...
        #     db.api_campaign.update({'title': campaign['title']}, 
        #     {'$set': {'start_at': campaign['start_time'], 'end_at': campaign['end_time']}}) 
        ...
        ## ----------- insert api_campaign
        lss_campaign_command = 'select * from lss_fb_campaign where fb_page_id="1679082475665513"'
        cursor.execute(lss_campaign_command)
        arimee_campaigns = cursor.fetchall()
